...
from .apidomain import movies as api_movies
from .apidomain import tvShows as api_tvShows
from .apidomain import anime as api_anime
...
_proxy_identifier = 'api-domain.proxies'
